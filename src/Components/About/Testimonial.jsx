  ...
  const ClientFeedBack = [
    {
      id: 1,
      message:
        "Their commitment to sustainable building materials transformed our project from a standard development into an award-winning landmark.",
    ...
    <section className="mt-10 md:mt-16 ">
      ...
      <div className="embla py-5">
        ...
        <div className="flex items-center justify-center gap-2 mt-3">
          <button
            onClick={goToPrev}
            className="p-3 rounded-full border border-primary hover:cursor-pointer"
          >
            <img src={back} alt="" />
          </button>
          <button
