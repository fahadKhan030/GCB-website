    ...
    <section className="mt-10 md:mt-16">
      <div className="mx-auto text-center flex items-center justify-center flex-col">
        ...
        <p className="text-gray-600 max-w-[600px] text-center">
          From conceptual drafting to final handover, we provide end-to-end
          solutions tailored to the unique landscape of Swat and across
          Pakistan.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-7 mt-8 md:mt-12 ">
        {expertise.map((data) => {
          return (
            <article className="bg-white  rounded-2xl p-5 border border-primary">
              <img
                src={data.img}
                alt=""
              ...
              <h4 className="font-semibold lg:text-xl text-md my-2">
                {data.title}
              </h4>
