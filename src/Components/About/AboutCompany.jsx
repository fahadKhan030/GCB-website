...
const AboutCompany = () => {
  ...
  return (
    <div
      className="flex flex-col gap-3 md:gap-10 md:flex-row md:justify-around justify-around md:items
    ...
    >
      <div className="max-w-[600px] md:hidden lg:block">
        ...
        <p className="my-4">
          Established in 2008, Green Consultants & Builders has grown into a
          premier engineering firm specializing in sustainable construction
          across Pakistan. From the rugged peaks of Swat to the urban centers of
          Karachi, we deliver excellence through ecological integrity.
        </p>
